Neste Case foi desenvolvido um modelo de Machine Learning com a função de predizer a partir da Regressão Linear as causas para o aumento dos valores de imóveis em uma área específica.
